...
%\begin{equation}
%\symPowerSeriesFunc(\symX) = 1 + \sum_{\symIndexL=1}^{\infty}
%\symA_\symIndexL \cos(2\pi\symIndexL\symX) + \symB_\symIndexL \sin(2\pi\symIndexL\symX)
%\end{equation}
%with coefficients
%\begin{equation}
%\begin{aligned}
%\symA_\symIndexL &= 2\log(2)\int_{-\infty}^\infty 2^\symX e^{-2^\symX}\cos(2\pi\symIndexL\symX)d\symX, \\
%\symB_\symIndexL &= 2\log(2)\int_{-\infty}^\infty 2^\symX e^{-2^\symX}\sin(2\pi\symIndexL\symX)d\symX.
%\end{aligned}
%\end{equation}
%Numerical evaluations give for the $\symA_1\approx \num{6.353e-6}$ and $\symB_1\approx \num{-7.572e-6}$.
