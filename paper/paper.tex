...
\begin{document}
\maketitle
\let\thefootnote\relax\footnotetext{This paper together with source code for all presented algorithms and simulations is available at \\ \url{https://github.com/oertl/hyperloglog-sketch-estimation-paper}. The first version of this paper was published on April 17, 2016.}
\begin{abstract}
...
\multicolumn{2}{c}{avg num evaluations}
\\
\# &  
