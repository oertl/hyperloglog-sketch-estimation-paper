...
Using the identity $2\symSmallCorrectionFunc(\symX) + \symLargeCorrectionFunc(\symX) = \symPowerSeriesFunc(\log_2(\log(1/\symX)))/\left(\log(2)\log(1/\symX)\right)$, we get for the linear counting case with $\symRegRange=0$
\begin{equation}
\symPoissonRateEstimate 
= 
