...
\begin{algorithm}
\caption{Cardinality estimation based on the improved raw estimator.}
...
\begin{algorithm}
\caption{Cardinality estimation based on the maximum likelihood principle.}
\ContinuedFloat
...
\begin{algorithm}
\caption{Cardinality estimation based on the maximum likelihood principle (continued).}
\begin{algorithmic}
\algrestore{myalg}
